//
//  DriverSpecialViewController.swift
//  ArzanTaxi
//
...
class DriverSpecialViewController : UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, DriverCargoControllerDelegate {
...
//    }()
    ...
    lazy var orderBar : OrderBar = {
        ...
        ob.driverSpecialController = self
...
//        navigationItem.title =
        ...
        collectionView.register(DriverSpecialOrdersCell.self, forCellWithReuseIdentifier: ordersCellID)
        collectionView.register(DriverSpecialCreateCell.self, forCellWithReuseIdentifier: createCellID)
        collectionView.register(DriverSpecialMyAutoCell.self, forCellWithReuseIdentifier: myOrdersCellID)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.item == 0 {
            let ordersCell = collectionView.dequeueReusableCell(withReuseIdentifier: ordersCellID, for: indexPath) as! DriverSpecialOrdersCell
            
            cell = ordersCell
        } else if indexPath.item == 1 {
            let autoCell = collectionView.dequeueReusableCell(withReuseIdentifier: createCellID, for: indexPath) as! DriverSpecialCreateCell
            autoCell.delegate = self
            
            cell = autoCell
        } else if indexPath.item == 2 {
            let myAutoCell = collectionView.dequeueReusableCell(withReuseIdentifier: myOrdersCellID, for: indexPath) as! DriverSpecialMyAutoCell
            cell = myAutoCell
        }
        return cell
    }
