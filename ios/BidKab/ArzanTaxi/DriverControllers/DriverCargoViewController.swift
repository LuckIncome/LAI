//
//  DriverCargoViewController.swift
//  ArzanTaxi
//
...
class DriverCargoViewController : UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, DriverCargoControllerDelegate {
...
//        navigationItem.title = String.localizedString(key: "cargo")
        ...
        collectionView.register(DriverCargoOrdersCell.self, forCellWithReuseIdentifier: ordersCellID)
        collectionView.register(DriverCargoCreateCell.self, forCellWithReuseIdentifier: createCellID)
        collectionView.register(DriverCargoMyAutoCell.self, forCellWithReuseIdentifier: myOrdersCellID)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.item == 0 {
            let ordersCell = collectionView.dequeueReusableCell(withReuseIdentifier: ordersCellID, for: indexPath) as! DriverCargoOrdersCell
            
            cell = ordersCell
        } else if indexPath.item == 1 {
            let autoCell = collectionView.dequeueReusableCell(withReuseIdentifier: createCellID, for: indexPath) as! DriverCargoCreateCell
            autoCell.delegate = self
            
            cell = autoCell
        } else if indexPath.item == 2 {
            let myAutoCell = collectionView.dequeueReusableCell(withReuseIdentifier: myOrdersCellID, for: indexPath) as! DriverCargoMyAutoCell
            cell = myAutoCell
        }
        return cell
    }
