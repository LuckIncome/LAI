...
class DriverVipMyOrdersCell: UITableViewCell {
    ...
    var price = Helper.createOrderLabel(image: #imageLiteral(resourceName: "price"), text: "")
    var status = Helper.createOrderLabel(image: UIImage(), text: "")
...
extension DriverVipMyOrdersCell: UICollectionViewDelegate, UICollectionViewDataSource {
