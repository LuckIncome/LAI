...
class DriverSpecialCreateCell: UICollectionViewCell, UITextFieldDelegate, MaskedTextFieldDelegateListener {
    ...
    lazy var priceTextField = Helper.createAutoTextFieldForSpecial(image: #imageLiteral(resourceName: "price"), placeholder: .localizedString(key: "price"), tag: 3, delegate: self)
    lazy var noteTextField = Helper.createAutoTextFieldForSpecial(image: #imageLiteral(resourceName: "comment"), placeholder: .localizedString(key: "note"), tag: 5, delegate: self)
...
extension DriverSpecialCreateCell: UIImagePickerControllerDelegate, UINavigationControllerDelegate  {
...
extension DriverSpecialCreateCell: UICollectionViewDelegate, UICollectionViewDataSource {
