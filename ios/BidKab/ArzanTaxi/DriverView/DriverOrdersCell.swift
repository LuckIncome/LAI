...
class DriverOrdersCell: UICollectionViewCell, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    func loadItems() {
        let url = Constant.api.driver_inter_orders
...
//                        o.phone = i["phone"].stringValue
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.price.text = "\(String(describing: order.price!))"
