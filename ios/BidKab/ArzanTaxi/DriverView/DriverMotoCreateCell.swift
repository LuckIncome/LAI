...
class DriverMotoCreateCell: UICollectionViewCell, UITextFieldDelegate, MaskedTextFieldDelegateListener {
    var delegate : DriverMotoControllerDelegate?
    ...
    lazy var priceTextField = Helper.createAutoTextFieldForMoto(image: #imageLiteral(resourceName: "price"), placeholder: .localizedString(key: "price"), tag: 3, delegate: self)
    lazy var noteTextField = Helper.createAutoTextFieldForMoto(image: #imageLiteral(resourceName: "comment"), placeholder: .localizedString(key: "note"), tag: 5, delegate: self)
...
extension DriverMotoCreateCell: UIImagePickerControllerDelegate, UINavigationControllerDelegate  {
...
extension DriverMotoCreateCell: UICollectionViewDelegate, UICollectionViewDataSource {
