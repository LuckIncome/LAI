...
class DriverMotoMyAutoCell: RefresherCell, UITableViewDelegate, UITableViewDataSource, OptionDelegate  {
    ...
    func loadItems() {
        ...
        let url = Constant.api.driver_moto_my_order + token
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.date = Helper.createOrderLabel(image: #imageLiteral(resourceName: "price"), text: items[indexPath.row].created_at!)
        ...
        if items[indexPath.row].status! == 0 {
            ...
            cell.status = Helper.createOrderLabel(image: #imageLiteral(resourceName: "notifications"), text: "Active", color: .green)
        }
        cell.setupViews()
