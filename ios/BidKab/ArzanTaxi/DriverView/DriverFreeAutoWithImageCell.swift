//
//  DriverFreeAutoWithImageCell.swift
//  ArzanTaxi
//
...
class DriverFreeAutoWithImageCell: UITableViewCell {
...
//        }
        ...
        phoneButton.widthAnchor.constraint(equalToConstant: 40).isActive = true
...
extension DriverFreeAutoWithImageCell: UICollectionViewDelegate, UICollectionViewDataSource {
