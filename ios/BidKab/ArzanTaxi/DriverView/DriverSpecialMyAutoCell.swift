...
class DriverSpecialMyAutoCell: RefresherCell, UITableViewDelegate, UITableViewDataSource, OptionDelegate {
    ...
    func loadItems() {
        ...
        let url = Constant.api.driver_special_my_order + token
