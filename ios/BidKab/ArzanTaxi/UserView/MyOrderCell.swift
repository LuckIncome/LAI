...
class MyOrderCell : RefresherCell, UITableViewDelegate, UITableViewDataSource, OptionDelegate {
    ...
    func loadItems() {
        ...
        let url = Constant.api.cargo_my_order + token!
    ...
    override init(frame: CGRect) {
        ...
        tableView.register(CargoOrderCell.self, forCellReuseIdentifier: cellID)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as! CargoOrderCell
        cell.option = self
