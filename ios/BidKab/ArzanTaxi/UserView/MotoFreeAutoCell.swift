...
class MotoFreeAutoCell: RefresherCell, UITableViewDelegate, UITableViewDataSource {
    ...
    func loadItems() {
        let url = Constant.api.moto_free_auto
...
//                            o.phone = i["phone"].stringValue
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.price.text = "\(String(describing: items[indexPath.row].price!))₸"
