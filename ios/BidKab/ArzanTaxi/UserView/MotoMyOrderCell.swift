...
class MotoMyOrderCell: RefresherCell, UITableViewDelegate, UITableViewDataSource, OptionDelegate  {
    ...
    func loadItems() {
        ...
        let url = Constant.api.moto_my_order + token
