...
class ToyMyOrderCell: RefresherCell, UITableViewDelegate, UITableViewDataSource, OptionDelegate {
    let cellID = "CellID"
    var items = [Order]()
    ...
    func loadItems() {
        ...
        let url = Constant.api.toy_my_order + token
